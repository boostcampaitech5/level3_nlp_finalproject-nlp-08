function ChattingSideBar() {
    return (
        <div className="w-full overflow-x-hidden">
            <aside id="separator-sidebar" className="fixed top-12 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                    ...
                    <ul className="space-y-2 font-medium">
                        <li>
                            <a href="/" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">법률 상담</span>
                            </a>
                        </li>
                    </ul>
                    <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                        <li>
                            <a href="https://github.com/boostcampaitech5/level3_nlp_finalproject-nlp-08" target="_blank" rel="noopener noreferer nofollow" className="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
