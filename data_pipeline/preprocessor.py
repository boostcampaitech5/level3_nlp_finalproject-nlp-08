...
def remove_unknown(raw_text: str) -> str:
    pass
...
def preprocess(raw_text: str) -> str:
    ...
    preprocess_functions = [remove_header, remove_footer, remove_escape, remove_phone_number, remove_hyperlink]
...
if __name__ == "__main__":
    ...
    preprocessed_df = df.assign(
        content = df["content"].apply(preprocess),
